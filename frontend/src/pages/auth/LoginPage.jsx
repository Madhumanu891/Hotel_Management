...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right — Login form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-slate-900">        <div className="w-full max-w-md">
        {/* Mobile logo */}
        ...
        {/* Demo accounts */}
        <div className="mt-8 p-4 bg-gray-50 dark:bg-slate-800 rounded-xl border dark:border-slate-700">          <p className="text-xs font-medium text-gray-500 mb-3">Demo accounts</p>
